  ...
  return (
    <div className='pt-[8rem] pb-[4rem] bg-[#02050a]'>
        ...
        <div data-aos="fade-right"
            data-aos-offset="300"
             data-aos-easing="ease-in-sine" className='flex items-center space-x-6'>
            ...
            <div >
                ...
                <p className='text-[17px] w-[90%] opacity-60 text-white'>Malir Saudabad Karachi</p>
            </div>    
        </div>
        <div data-aos="fade-down"
            data-aos-easing="linear"
            data-aos-duration="1500" className='flex items-center space-x-6'>
            <div className='md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#55e6a5] '>
            <DevicePhoneMobileIcon className='md:w-[4rem] md:h-[4rem] w-[3.5rem] h-[3.5rem] text-black' />
            </div>
            <div>
                <h1 className='text-[25px] mb-[0.2rem] font-semibold text-white'>Phone</h1>
                <p className='text-[17px] w-[90%] opacity-60 text-white'>+923056835975<br/>
                +923453411202
                </p>
            </div>
           </div>
           <div data-aos="fade-left"
            ...
            <div>
                ...
                <p className='text-[17px] w-[90%] opacity-60 text-white'>tahir.meng@gmail.com<br/>
                tahir.eng@hotmail.com
                </p>
            </div>
           </div>
         </div>
         <div data-aos="fade-up"
     data-aos-duration="3000" className='w-[80%] mt-[2rem] mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-between'>
          <div className='text-[16px] mb-[2rem] md:mb-0  text-white opacity-20'>
          webtech tahir 2024 | All right reserved
          </div>
